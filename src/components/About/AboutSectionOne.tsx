        ...
        <div className="border-b border-body-color/[.15] pb-16 dark:border-white/[.15] md:pb-20 lg:pb-28">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <SectionTitle
                title="L’excellence au service de votre succès digital."
                paragraph="Nous ne nous contentons pas de créer des sites web, nous construisons des solutions digitales sur-mesure. Notre approche combine analyse concurentielle, expertise technique, créativité et stratégie."
                mb="44px"
              />
